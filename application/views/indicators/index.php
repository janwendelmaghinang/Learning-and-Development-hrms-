            ...
            <div class="form-group">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <select class="form-control" name="leadership" id="leadership">
                      <?php foreach ($key_indicator as $indicator): ?>
                        <option value="<?php echo $indicator['id'] ?>">
                          <?php echo $indicator['name'] ?>
                        </option>
                      <?php endforeach; ?>
                    </select>
                  </td>
                ...
                <tr>
                  <td>Enthusiasm</td>
                  <td>
                    <select class="form-control" name="enthusiasm" id="enthusiasm">
                      <?php foreach ($key_indicator as $indicator): ?>
                        <option value="<?php echo $indicator['id'] ?>">
                          <?php echo $indicator['name'] ?>
                        </option>
                ...
                <tr>
                  <td>Teamwork</td>
                  <td>
                    <select class="form-control" name="teamwork" id="teamwork">
                      <?php foreach ($key_indicator as $indicator): ?>
                        <option value="<?php echo $indicator['id'] ?>">
                          <?php echo $indicator['name'] ?>
                        </option>
                ...
                <tr>
                  <td>Integrity</td>
                  <td>
                    <select class="form-control" name="integrity" id="integrity">
                      <?php foreach ($key_indicator as $indicator): ?>
                        <option value="<?php echo $indicator['id'] ?>">
                          <?php echo $indicator['name'] ?>
                        </option>
        ...
        <form role="form" action="<?php echo base_url('Indicators/update') ?>" method="post" id="updateIndicatorForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="edit_Indicator_name" name="edit_Indicator_name"
                placeholder="Enter Indicator name" autocomplete="off">
            </div>
            <div class="form-group">
